export default {
  ...
  'user-login.login.invalid-credentials': 'Invalid username or password.',
  'user-login.login.email-not-verified': 'E-mail is not verified.',
  'user-login.login.logout-message': 'Successfully logged out!',
