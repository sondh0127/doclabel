...
export default [
  {
    ...
    routes: [
      ...
      },
      {
        ...
        component: './user/auth/Activation',
      },
      {
        name: 'resend-activation',
        path: '/user/resend-activation',
        component: './user/auth/ResendActivation',
      },
      {
        name: 'oauth',
        path: '/user/oauth/:provider',
        component: './user/auth/OAuthLogin',
      },
      {
        name: 'reset-password',
        path: '/user/reset-password',
        component: './user/auth/ResetPassword',
      },
      {
        name: 'reset-password-confirm',
        path: '/user/reset-password/confirm/:uid/:token',
        component: './user/auth/ResetPasswordConfirm',
      },
      {
